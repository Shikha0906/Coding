<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-products5049/1?_gl=1*vix85i*_up*MQ..&gclid=CjwKCAjwyabTBhBFEiwAM3mNUO-7Ap5_nwYnFV5DYt2PZ8HxDtSdxPozMwFqjltsfw_kYfGsMnV-NhoCVBcQAvD_BwE&gbraid=0AAAAAC9yBkCHYir4A3w7dpW9BVebPaoo1">Sum of Pairwise ANDs</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of integers, calculate the sum of bitwise AND for all pairs of elements such that the first index is less than the second index.</span></p>
